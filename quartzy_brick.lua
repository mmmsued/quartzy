...
local definition = {    					-- Beginn verschachtelte Tabelle »definition« für »Quartzy Brick«
	{"quartzy_brick_white", "Brick white"}, -- 1. Eintrag der Unter-Tabelle für Node-Name, Textur, Rezept - 2. Eintrag für Description
	{"quartzy_brick_light_gray", "Brick light gray"},
	{"quartzy_brick_gray", "Brick gray"},
	{"quartzy_brick_dark_gray", "Brick dark gray"},
	{"quartzy_brick_pink", "Brick pink"},
	{"quartzy_brick_dark_pink", "Brick dark pink"}
...
-- Rezepte für »Quartzy Brick« herstellen
local crafting_array = {    					-- Beginn verschachtelte Tabelle für »Quartzy Brick«-Rezepte
	{"quartzy:quartzy_raw", "quartzy:quartzy_raw", ""},
	{"", "", ""},
	{"", "", ""}
}												-- Ende verschachtelte Tabelle für »Quartzy Brick«-Rezepte
